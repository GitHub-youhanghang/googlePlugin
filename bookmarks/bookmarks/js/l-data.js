...
// var data=[];
  ...
  $('body').append('<div id="youhanghangContent" class="youhanghang-content"><h2><a id="editBookmarks" title="编辑书签" class="icono-trash new"></a><a id="addBookMarks" title="添加书签" class="icono-plus new"></a></h2><div id="swithBookmarksBtn" class="swith-bookmarks-btn" ></div><div id="youhanghangMenu" class="youhanghang-menu" ></div>');
